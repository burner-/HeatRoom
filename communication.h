...
typedef struct _CompressorInfo {
    ...
    bool has_pidOutput;
    float pidOutput;
/* @@protoc_insertion_point(struct:CompressorInfo) */
} CompressorInfo;
...
/* @@protoc_insertion_point(struct:CompressorSettings) */
} CompressorSettings;
...
/* @@protoc_insertion_point(struct:FlowInfo) */
} FlowInfo;
...
typedef struct _PIDInfo {
    ...
    bool has_dispD;
    float dispD;
/* @@protoc_insertion_point(struct:PIDInfo) */
} PIDInfo;
...
typedef struct _TempInfo {
    ...
    bool has_Temp;
    float Temp;
/* @@protoc_insertion_point(struct:TempInfo) */
} TempInfo;
